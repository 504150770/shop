...
public class OrderController {
    ...
    public ModelAndView order(OrderQuery orderQuery){
        ...
        User user = userDao.selectById(Function.getUserId(request));
    ...
    public void evaluation(int orderId,String evaluation) throws IOException {
        //更新订单状态为5：已完成
        orderDao.evaluation(orderId,evaluation);
        response.sendRedirect("/order/");
    }
